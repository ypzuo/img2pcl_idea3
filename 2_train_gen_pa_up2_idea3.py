...
if __name__ == '__main__':
	...
	with tf.variable_scope('generator') as scope:
		...
		up_l2_points, l1_points, _ = get_local_features(pcl_in, is_training=True, scope=scope,
		...
		net = concat_features(features, up_l2_points, l1_points, global_feature, is_training, scope, reuse=None, 
				bn_decay=None,)   #features B,1024,240 ; up_l2_points B,1024,64 ; l1_points B,1024,64 ; global_feature B,1024,64
